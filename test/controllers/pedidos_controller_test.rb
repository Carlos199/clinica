...
class PedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pedido" do
    assert_difference('Pedido.count') do
      post pedidos_url, params: { pedido: { codigo: @pedido.codigo, proveedore_id: @pedido.proveedore_id, user_id: @pedido.user_id } }
    end
  ...
  test "should update pedido" do
    patch pedido_url(@pedido), params: { pedido: { codigo: @pedido.codigo, proveedore_id: @pedido.proveedore_id, user_id: @pedido.user_id } }
