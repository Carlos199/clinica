...
class DetallepedidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create detallepedido" do
    assert_difference('Detallepedido.count') do
      post detallepedidos_url, params: { detallepedido: { item_id: @detallepedido.item_id, observaciones: @detallepedido.observaciones, pedido_id: @detallepedido.pedido_id, solicitado: @detallepedido.solicitado, surtido: @detallepedido.surtido } }
    end
  ...
  test "should update detallepedido" do
    patch detallepedido_url(@detallepedido), params: { detallepedido: { item_id: @detallepedido.item_id, observaciones: @detallepedido.observaciones, pedido_id: @detallepedido.pedido_id, solicitado: @detallepedido.solicitado, surtido: @detallepedido.surtido } }
