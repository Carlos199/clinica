...
class MedicosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create medico" do
    assert_difference('Medico.count') do
      post medicos_url, params: { medico: { apellido: @medico.apellido, celular: @medico.celular, ci: @medico.ci, ciudade_id: @medico.ciudade_id, contacto_familiar: @medico.contacto_familiar, correo: @medico.correo, direccion: @medico.direccion, especialidade_id: @medico.especialidade_id, fecha: @medico.fecha, nombre: @medico.nombre, nro_registo: @medico.nro_registo, telefono: @medico.telefono } }
    end
