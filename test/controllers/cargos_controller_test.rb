...
class CargosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cargo" do
    assert_difference('Cargo.count') do
      post cargos_url, params: { cargo: { codigo: @cargo.codigo, descripcion: @cargo.descripcion, nombre: @cargo.nombre } }
    end
  ...
  test "should update cargo" do
    patch cargo_url(@cargo), params: { cargo: { codigo: @cargo.codigo, descripcion: @cargo.descripcion, nombre: @cargo.nombre } }
