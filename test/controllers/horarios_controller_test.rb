...
class HorariosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create horario" do
    assert_difference('Horario.count') do
      post horarios_url, params: { horario: { dia_id: @horario.dia_id, horaFin: @horario.horaFin, horaIni: @horario.horaIni, medico_id: @horario.medico_id } }
    end
  ...
  test "should update horario" do
    patch horario_url(@horario), params: { horario: { dia_id: @horario.dia_id, horaFin: @horario.horaFin, horaIni: @horario.horaIni, medico_id: @horario.medico_id } }
