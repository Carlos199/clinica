...
class ReservasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reserva" do
    assert_difference('Reserva.count') do
      post reservas_url, params: { reserva: { estado_id: @reserva.estado_id, fecha: @reserva.fecha, hora: @reserva.hora, medico_id: @reserva.medico_id, observaciones: @reserva.observaciones, paciente_id: @reserva.paciente_id } }
    end
  ...
  test "should update reserva" do
    patch reserva_url(@reserva), params: { reserva: { estado_id: @reserva.estado_id, fecha: @reserva.fecha, hora: @reserva.hora, medico_id: @reserva.medico_id, observaciones: @reserva.observaciones, paciente_id: @reserva.paciente_id } }
