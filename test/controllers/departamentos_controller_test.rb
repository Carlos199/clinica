...
class DepartamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create departamento" do
    assert_difference('Departamento.count') do
      post departamentos_url, params: { departamento: { codigo: @departamento.codigo, nombre: @departamento.nombre, regione_id: @departamento.regione_id } }
    end
  ...
  test "should update departamento" do
    patch departamento_url(@departamento), params: { departamento: { codigo: @departamento.codigo, nombre: @departamento.nombre, regione_id: @departamento.regione_id } }
