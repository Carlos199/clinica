...
class EspecialidadesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create especialidade" do
    assert_difference('Especialidade.count') do
      post especialidades_url, params: { especialidade: { codigo: @especialidade.codigo, descripcion: @especialidade.descripcion } }
    end
  ...
  test "should update especialidade" do
    patch especialidade_url(@especialidade), params: { especialidade: { codigo: @especialidade.codigo, descripcion: @especialidade.descripcion } }
