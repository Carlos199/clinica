...
class ProveedoresControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create proveedore" do
    assert_difference('Proveedore.count') do
      post proveedores_url, params: { proveedore: { apellido: @proveedore.apellido, cellular: @proveedore.cellular, ci: @proveedore.ci, ciudade_id: @proveedore.ciudade_id, correo: @proveedore.correo, direccion: @proveedore.direccion, empresa_id: @proveedore.empresa_id, foto: @proveedore.foto, nombre: @proveedore.nombre, telefono: @proveedore.telefono } }
    end
  ...
  test "should update proveedore" do
    patch proveedore_url(@proveedore), params: { proveedore: { apellido: @proveedore.apellido, cellular: @proveedore.cellular, ci: @proveedore.ci, ciudade_id: @proveedore.ciudade_id, correo: @proveedore.correo, direccion: @proveedore.direccion, empresa_id: @proveedore.empresa_id, foto: @proveedore.foto, nombre: @proveedore.nombre, telefono: @proveedore.telefono } }
